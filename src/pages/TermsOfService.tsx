  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0B0D10]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-black dark:text-[#E9EEF5] mb-4">Terms of Service</h1>
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-700">
              By accessing or using AI Boost Campaign ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              AI Boost Campaign provides an AI-powered marketing automation platform that includes:
            </p>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4">
              The Service and its original content, features, and functionality are owned by AI Boost Campaign and are protected by copyright, trademark, and other intellectual property laws.
            </p>
          ...
          <section>
            ...
            <p className="text-gray-700">
              You agree to indemnify and hold harmless AI Boost Campaign and its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including attorney fees) arising from your use of the Service, violation of these Terms, or infringement of any third-party rights.
            </p>
          </section>
