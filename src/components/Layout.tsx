...
const Layout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-[#0B0D10]">
      {/* Sidebar */}
      <aside className="w-64 bg-white dark:bg-[#0B0D10] shadow-sm dark:shadow-none border-r border-gray-200 dark:border-[#273140] flex flex-col">
        ...
        {user && (
          <div className="p-4 border-t border-gray-200 dark:border-[#273140] flex-shrink-0">
